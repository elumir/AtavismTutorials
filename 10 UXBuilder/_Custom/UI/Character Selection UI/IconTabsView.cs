...
public class IconTabsView : VisualElement
{
    ...
    internal new class UxmlTraits : VisualElement.UxmlTraits {
        ...
        private readonly UxmlIntAttributeDescription m_StartTabIndex = new UxmlIntAttributeDescription { name = "startTabIndex", defaultValue = 0 };        
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
        {
            ...
            item.StartTabIndex = m_StartTabIndex.GetValueFromBag(bag, cc);
        }
    }
...
//    private const string f_UxmlName = "IconTabsView"; // Nothing really in here so not using
    ...
    public void ResetTab()
    {
        if (m_TabContent != null)
        {
            ...
            m_ActiveTab = (IconTab)m_TabContent[m_StartTabIndex];
            SelectTab(m_ActiveTab);
        }
    }
