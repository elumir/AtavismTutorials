...
namespace Game.UI
{
	public class PopupMessage : PopupPanel
	{
		...
		private const string ussClassFont = "font";
		...
		private const string ussClassButton = "button";
			...
			: base()
		{
			...
			headingLabel.AddToClassList(ussClassFont);
			...
			confirmButton.AddToClassList(ussClassButton);
			cancelButton.AddToClassList(ussClassButton);
