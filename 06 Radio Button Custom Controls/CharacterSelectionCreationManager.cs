...
//                    if( !genders[g].rootGameObject.activeSelf) genders[g].rootGameObject.SetActive(true);
                }
                g++;
            }
...
//                genderSlot.GenderSelected(genderId);
        ...
        public void UIGenderClicked(IconRadio radio) // When New UI gender is selected
        {
